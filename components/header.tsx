...
export function Header() {
  ...
  return <header className="fixed inset-x-0 top-0 z-50">
    <div className="relative flex h-24 w-full items-center justify-between rounded-b-[28px] border-x border-b border-white/15 bg-[#07111f]/80 px-5 shadow-[0_18px_60px_rgba(0,0,0,.35),inset_0_1px_0_rgba(255,255,255,.08)] backdrop-blur-2xl sm:px-8 lg:px-[max(40px,calc((100vw-1180px)/2))]">
